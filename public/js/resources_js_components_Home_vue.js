...
var staticRenderFns = [
  function() {
    ...
    return _c(
      "div",
      { staticClass: "min-h-screen w-full h-full bg-black-main relative" },
      [
        _c(
          "div",
          { staticClass: "w-1/12 fixed left-0 top-0 bottom-0 bg-black-side" },
          [
            _c("div", { staticClass: "w-full h-1/4" }),
            _vm._v(" "),
            _c("div", { staticClass: "w-full h-1/4" }, [
              _c(
                "div",
                {
                  staticClass:
                    "w-full h-1/5 border-t border-b border-gray-side align-content-center justify-center "
                },
                [
                  _c("span", { staticClass: "text-gray-font text-lg" }, [
                    _vm._v("About")
                  ])
                ]
              ),
              _vm._v(" "),
              _c("div", {
                staticClass: "w-full h-1/5 border-b border-gray-side"
              }),
              _vm._v(" "),
              _c("div", {
                staticClass: "w-full h-1/5 border-b border-gray-side"
              ...
              _vm._v(" "),
              _c("div", { staticClass: "w-full h-1/5 border-gray-side" }),
              _vm._v(" "),
              _c("div", {
                staticClass: "w-full h-1/5 border-t border-b border-gray-side"
              })
            ]),
            _vm._v(" "),
            _c("div", { staticClass: "w-full h-1/4" })
        ...
        _vm._v(" "),
        _c("div", { staticClass: "w-11/12  bg-white" })
      ]
    )
  }
]
